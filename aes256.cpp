...
array<unsigned char, 16> AES_256::encrypt(array<unsigned char, 16> input_bytes, QVector<unsigned char> key)
{
...
array<unsigned char, 16> AES_256::decrypt(array<unsigned char, 16> cipher, QVector<unsigned char>  key)
{
    array<array<unsigned char, nb>, 4> state;
    for (unsigned int r = 0; r < 4; r++)
    {
...
array<array<unsigned char, nb>, 4> AES_256::subBytes(array<array<unsigned char, nb>, 4> state, bool inv)
{
...
array<unsigned char, nb> AES_256::leftRightShift(array<unsigned char, nb> array, unsigned int count, bool inv)
{
    unsigned char el;
...
array<array<unsigned char, nb>, 4> AES_256::shiftRows(array<array<unsigned char, nb>, 4> state, bool inv)
{
...
unsigned char AES_256::mul_by_02(unsigned char num)
{
    unsigned char res;
...
unsigned char AES_256::mul_by_03(unsigned char num)
{
    return (mul_by_02(num) ^ num);
}


unsigned char AES_256::mul_by_09(unsigned char num)
{
    return mul_by_02(mul_by_02(mul_by_02(num))) ^ num;
}


unsigned char AES_256::mul_by_0b(unsigned char num)
{
    return mul_by_02(mul_by_02(mul_by_02(num))) ^ mul_by_02(num) ^ num;
}


unsigned char AES_256::mul_by_0d(unsigned char num)
{
    return mul_by_02(mul_by_02(mul_by_02(num))) ^ mul_by_02(mul_by_02(num)) ^ num;
}


unsigned char AES_256::mul_by_0e(unsigned char num)
{
    return mul_by_02(mul_by_02(mul_by_02(num))) ^ mul_by_02(mul_by_02(num)) ^ mul_by_02(num);
}

array<array<unsigned char, nb>, 4> AES_256::mixColumns(array<array<unsigned char, nb>, 4> state, bool inv)
{
...
array<array<unsigned char, nb>, 4> AES_256::addRoundKey(array<array<unsigned char, nb>, 4> state, array<array<unsigned char, nb * (nr + 1)>, 4> key_schedule, unsigned int round)
{
    unsigned char s0, s1, s2, s3;
...
array<array<unsigned char, nb * (nr + 1)>, 4> AES_256::key_expansion(QVector<unsigned char> key)
{
