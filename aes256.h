...
private:
    ...
    array<unsigned char, 256> inv_sbox {
     ...
     array< array<unsigned char, 10>, 4> con {
        array<unsigned char, 10> {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36},
        array<unsigned char, 10> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        array<unsigned char, 10> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        array<unsigned char, 10> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
        };
     ...
     array<array<unsigned char, nb * (nr + 1)>, 4> key_expansion(QVector<unsigned char> key);
